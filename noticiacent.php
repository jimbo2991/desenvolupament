...
$result=mysqli_query($link,"select codigo_noticia, titulo, contenido, foto, fecha, hora_publicacion, codigo_redactor from noticia order by codigo_noticia desc limit 1,1");
