...
$pedido=$_REQUEST['nombre'];
$er=0;
$link=mysqli_connect("localhost","root","dkgamers","dekagamers");
$result=mysqli_query($link,"select vi.codigo_videojuego,vi.titulo,vi.plataforma,vi.precio, ve.codigo_V, avg(va.valoracion) from videojuego vi, vende ve, valora va, cesta ce  where vi.codigo_videojuego=ce.codigo_videojuego and ce.cod_pedido='$pedido' group by ce.codigo_videojuego ");
...
<table bgcolor="" border="5" cellpadding="10" cellspacing="10" width="60%">
<tr>
<td>id producto</td><td>titulo videojuego</td><td>plataforma</td><td>PVP</td><td>vendedor</td><td>ver producto?</td><!--<td>direccion</td><td>roles</td><td>editar</td><td>borrar</td>-->
</tr>
<?
...
<td><?echo $row[3];?></td>
<td><?echo $row[4];?></td>
<td><width="20%"><form action="admproducto.php" method="post"><input type="hidden" name="nombre" value="<?php print $row[0]?>"><input type="submit" value="ver producto"></form></td>
</tr>
<?
}
?>
