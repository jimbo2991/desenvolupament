...
$result=mysqli_query($link,"delete from registro where id='$letra';");
$result2=mysqli_query($link,"delete from cliente where codigo='$letra';");
$result3=mysqli_query($link,"delete from vendedor where codigo='$letra';");
$result4=mysqli_query($link,"delete from redactor where codigo='$letra';");
$result5=mysqli_query($link,"delete from usuario where id='$letra';");
 if (!$result2){
