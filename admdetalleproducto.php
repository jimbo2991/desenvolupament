...
$query="select * from videojuego where codigo_videojuego='$letra';";
}
else {
...
echo "Se ha encontrado a ".$prueba." videojuegos";
?>
<table bgcolor="" border="5" cellpadding="10" cellspacing="10" width="60%">
<tr>
<td>id</td><td>titulo videojuego</td><td>compañia</td><td>plataforma</td><td>fecha_venta</td><td>PVP</td><td>descripcion</td><td>genero</td><td>foto</td><td>disponibilidad</td>
</tr>
<?
