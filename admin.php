...
<tr>
<td>Gestion de Usuarios</td><td><a href="admusuarios.php"><input type="button" value="editar"></a></td>
</tr><tr>
<td>Gestion de Tienda</td><td><a href="admtienda.php"><input type="button" value="editar"></a></td>
</tr><tr>
<td>Gestion de Noticias</td><td><a href="admnoticias.php"><input type="button" value="editar"></a></td>
</tr><tr>
<td>Gestion de Concursos</td><td><a href="admconcursos".php><input type="button" value="editar"></a></td>
</tr>
</table>
			</div>
	<div>
