...
$query="select * from pedido where cliente like '$letra%' and validado=0;";
}
else {
$query="select * from pedido where validado=0;";
}
$er=0;
...
mysqli_close($link);
	?>
	<br>
	<form action="admborrapedidonovalidos.php" method="post">
	<table bgcolor="" border="5" cellpadding="10" cellspacing="10" width="60%">
	<tr>
	<td>desea borrar todos los pedidos no completados?</td><td>Si <input type='checkbox' name="confirmar" value='1'></td><td><input type="submit" value="borrar"></td>
	</tr>
	</table>
	</form>
			<div class="relleno"></div>
