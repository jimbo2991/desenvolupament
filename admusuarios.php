...
<table bgcolor="" border="5" cellpadding="10" cellspacing="10" width="60%">
<tr>
<td>id</td><td>nif</td><td>nombre</td><td>apellido</td><td>email</td><td>telefono</td><td>direccion</td><td>roles</td><td>editar</td><td>borrar</td>
</tr>
<?
...
<td><?echo $row[5];?></td>
<td><?echo $row[6];?></td>
<td><width="20%"><form action="admuserroles.php" method="post"><input type="hidden" name="nombre" value="<?php print $row[0]?>"><input type="submit" value="roles"></form></td>
<td><width="20%"><form action="admmoduser.php" method="post"><input type="hidden" name="nombre" value="<?php print $row[0]?>"><input type="submit" value="editar"></form></td>
<td><width="20%"><form action="admborrauser.php" method="post"><input type="hidden" name="nombre" value="<?php print $row[0]?>"><input type="submit" value="borrar"></form></td>
</tr>
<?
}
?>
